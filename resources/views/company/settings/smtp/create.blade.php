<x-app-layout>
    ...
    <div class="py-4">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form action="{{ route('company.settings.smtp_settings.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('from_name') is-invalid @enderror" id="from_name" name="from_name" value="{{ old('from_name', auth()->user()->company->name) }}" required>
                            @error('from_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
